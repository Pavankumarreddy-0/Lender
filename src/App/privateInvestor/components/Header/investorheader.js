...
import PrivateSideDrawer from '../SideDrawer/PrivateSideDrawer';


export default function InvestorHeader({user}) {
...
// style={("accentBg" in __webAppSettings.activeTheme) ? {background: __webAppSettings.activeTheme.accentBg} : {}}
  ...
  return (
    <>
    <PrivateSideDrawer webAppSettings={__webAppSettings} setWebSettings={__updateWebAppSettings}/> 
        ...
        <div style={("accentBg" in __webAppSettings.activeTheme) ? {background: __webAppSettings.activeTheme.accentBg} : {}} className={headerStyles['headerRightRegion']}>
          <ul className={headerStyles['headerRightIconsList']}>
            <li   className={headerStyles['headerRightIconsItem']}>
              <Link style={{ color: __webAppSettings.activeTheme.textColor}} to="/investor/settings">
                <i className="bi bi-gear"></i>
              </Link>
            </li>
            <li   className={headerStyles['headerRightIconsItem']}>
              <Link style={{ color: __webAppSettings.activeTheme.textColor}} to="/investor/faq">
                    ...
                    <div className={headerStyles['headerSubProfileSectionBody']}>
                      ...
                      <div className={headerStyles['headerSubProfileListRight']}>
                        <div className={headerStyles['headerSubProfileMeta']}>
                            <p className={headerStyles['headerSubProfileMetaName']}>{ __webAppSettings.userProfile.firstName }</p>
                        </div>
                        <div className={headerStyles['headerRightProfileSubItem']}>
                          <Link onClick={()=> setHeaderData({...headerData, profileDetailsMenu: false})} className={headerStyles['headerRightProfileManageLink']} to="/investor/settings/profile">Manage Profile</Link>
                        </div>
                        <div className={headerStyles['headerRightProfileSubItem']}>
