  ...
  const[createRole,setCreateRole] =useState({
    ...
    privilages: {
      ...
      "Appropriatenesstestversion": {
        ...
        "childrens": [
          {
            "privilageName": "Update appropriateness test questions list and test config",
            "privilageComparator": 2
          }
        ]
      },
      ...
      "Modulesactivationsettings": {
        ...
        "childrens": [
          ...
          {
            "privilageName": "Update WebApp Google Tag Manager activation settings",
            "privilageComparator": 4
          },
          {
      ...
      "Notificationtriggers": {
        ...
        "childrens": [
          ...
          {
            "privilageName": "View list of back office users notification triggers",
            "privilageComparator": 16
          },
          {
      ...
      "OfferingAgreements": {
        ...
        "childrens": [
          {
            "privilageName": "Create or update offering agreement and its versions",
            "privilageComparator": 2
          },
          {
      ...
      "Organizations": {
        ...
        "childrens": [
          ...
          {
            "privilageName": "Create organization payment destination bank account.",
            "privilageComparator": 8192
          },
          {
            "privilageName": "Update organization payment destination bank account.",
            "privilageComparator": 16384
          },
          {
            "privilageName": "Delete organization payment destination bank account.",
            "privilageComparator": 32768
          },
          {
      ...
      "Platformagreements": {
        ...
        "childrens": [
          {
            "privilageName": "Create or update platform agreement and its versions",
            "privilageComparator": 2
          },
          {
      ...
      "TranslatedStrings": {
        ...
        "childrens": [
          { "privilageName": "Reset WebApp translations", "privilageComparator": 2 }
        ]
      },
      "Translations": {
      ...
      "Wallets": {
        ...
        "childrens": [
          ...
          { "privilageName": "View wallet details page", "privilageComparator": 64 }
        ]
      },
      "WebappMenus": {
      ...
      "General": {
        ...
        "childrens": [
          { "privilageName": "User registered", "privilageComparator": 2 },
          {
            "privilageName": "Auto investment run result",
            "privilageComparator": 4
          },
          {
            "privilageName": "New comment is added to platform",
            "privilageComparator": 8
          },
          {
            "privilageName": "New comment is added to deal room",
            "privilageComparator": 16
          },
          {
            "privilageName": "New file is added to deal room",
            "privilageComparator": 32
          },
          { "privilageName": "Annual limit exceeded", "privilageComparator": 64 }
        ]
      }
    }
 ...
 <div className={createRoleStyle['CreateRolesHeaderContainer']}>
        <div className={createRoleStyle['CreateRolesHeaderContainerRegion']}>
          ...
          <p className={createRoleStyle['CreateRolesHeaderContainerName']}>Roles Management</p>
                ...
                <label className={createRoleStyle['role__permission__label']}> Page accessibility:</label>
                ...
                <div className={createRoleStyle["role_privilages"]}>
                  {
                    generateAccess(createRole.privilages).map((e)=>{
                      ...
                      return <Accordion key={e[0]} defaultActiveKey={e[0]}>
                       <Accordion.Item className={createRoleStyle["role_privilage_section"]} eventKey={e[0].sectionName}>
                        <Accordion.Header className={createRoleStyle["role_privilage_sectionTitle"]}>{e[1].sectionName}</Accordion.Header>
                        <Accordion.Body className={createRoleStyle["roleManagementAccordianBody"]}>
                        {
                              e[1].childrens.map((es)=>{
                                return <div key={es.privilageComparator} className={createRoleStyle["role_privilage_input"]}>
                                  ...
                                  <div className={createRoleStyle['checkbox__style']}>
                                    <input 
                                      ...
                                      checked={((createRole.permissions[e[0]] & es.privilageComparator) == es.privilageComparator) ? "checked" : ""} 
                                      onClick={(e)=>updatePrivilage(e)}
                                    />
                                    <label 
                                      className={createRoleStyle['checkbox__label']} 
                                      for={ es.privilageName } 
                                    > { es.privilageName }</label>
                                  </div>
