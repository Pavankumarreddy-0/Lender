...
import IndividualDataSidebar from './individualSidebar/IndividualDataSidebar';


export default function InvBasicInfo() {
                ...
                <div className={BasicInfoStyle['basicInfo-header']}>
                    ...
                    <div className={BasicInfoStyle['basic_info-button']}>
                       {(!newOrgVal.editMode) && <a href="javascript:void(0)" className={BasicInfoStyle['headerEditable']} onClick={() => setNewOrgVal({ ...newOrgVal,editMode: true, })}><i class="bi bi-pencil-square"></i>Edit</a>}
                        {(newOrgVal.editMode) && <a href="javascript:void(0)" className={BasicInfoStyle['headerEditable']} onClick={() => {
                            return;
                            // SaveOrgDetails()
                            }}>
                            ...
                            <div className={BasicInfoStyle['CardInner']}>
                                ...
                                <div className={BasicInfoStyle['customcardBody']}>
                                    ...
                                    <a href="javascript:void(0)" onClick={
                                        () => {return}
                                        // addCustomTags
                                        } className={BasicInfoStyle['addtagbtn']}>ADD</a>
                                </div>
                                <ul className={BasicInfoStyle['showcustomtags']}>
                                    {newOrgVal.customTags.map((elem, i) => {
                                        return <li key={elem} className={BasicInfoStyle['Tagname']}><span>{elem}</span><a href='javascript:void(0)' data-tagidx={i} onClick={(e) => 
                                           { return}
                                            // removeTag(e)
                                        }><i data-tagidx={i} class="bi bi-x"></i></a></li>
                                    })}
                                </ul>
                            </div>
                        </div>
