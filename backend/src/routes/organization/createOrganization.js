    ...
    handler: async (req, res) => {
        ...
        jwt.verify(
            ...
            async (err, decoded) => {
                ...
                //check if contect point already exist
                    ...
                    process.env.JWT_SECRET,
                {
                    ...
                    console.log("Generated Password", passwordGenLink)
                    if (err) {
                    ...
                    transporter.sendMail(mailOptions, function(error, info){
                        if (error) {
                            ...
                            res.status(200).json({ message: "Organization Created", emailSent: false, contactPoint: result3, organization: result2 })
                        } else {
                            console.log("sent")
                            res.status(200).json({ message: "Organization Created",emailSent: true, contactPoint: result3, organization: result2 })
                        }
                    });
